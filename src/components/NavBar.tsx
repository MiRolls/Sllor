...
const NavBar = () => {
  ...
  return (
    <Flex
      className={"fixed z-20 w-full items-center bg-accent"}
      justify="between"
      height={"9"}
      p={"3"}
    >
      ...
      <Box className="ml-2 hidden flex-1 sm:ml-3 sm:block">
        <Link href="/">
          {/* Site Name */}
          <Heading className="inline !w-auto">{site.name}</Heading>
        </Link>
      </Box>
      ...
      <Box className="">
        ...
        {/* Phone dropdown menu */}
        <Box className="inline sm:hidden">
          <DropdownMenu.Root>
